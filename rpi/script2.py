...
for index in range(1, 3):
    ...
    for x in myresult:
        ...
        sum_aqi_pm25 = sum_aqi_pm25 + x[7]
        sum_aqi_pm10 = sum_aqi_pm10 + x[8]

    sum_pm1 = sum_pm1 / rowcount
    sum_pm25 = sum_pm25 / rowcount
    sum_pm10 = sum_pm10 / rowcount
    sum_aqi_pm25 = sum_aqi_pm25 / rowcount
    sum_aqi_pm10 = sum_aqi_pm10 / rowcount

    mycursor2 = mydb.cursor()

    sql2 = "INSERT INTO tb_sumary (location, pm1, pm25, pm10, aqi_pm25, aqi_pm10) VALUES (%s, %s, %s, %s, %s, %s)"
    val2 = (location, sum_pm1, sum_pm25, sum_pm10, sum_aqi_pm25, sum_aqi_pm10)
