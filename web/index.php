            ...
            $.ajax({
                ...
                success:function(data) {
                    if (data.status == 'ok') {
                        ...
                        pm25 = data.result_01.pm25; // Value of pm2.5 as microgram
				
						var current_01 = data.result_01;
                        $('#pm25').text(current_01.pm25);
                        $('#pm1').text(current_01.pm1);
                        $('#pm10').text(current_01.pm10);
                        $('#temp').text(current_01.temp);
                        $('#humi').text(current_01.humi);
                        $('#aqi_pm25').text(current_01.aqi_pm25);
                        $('#aqi_pm10').text(current_01.aqi_pm10);
                        $('#location').text(current_01.location);
                        $('#timestamp').text(current_01.timestamp);
